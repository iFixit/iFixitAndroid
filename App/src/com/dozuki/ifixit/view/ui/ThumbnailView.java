...
public class ThumbnailView extends LinearLayout {
	...
	private void init(Context context) {
		...
		inflater.inflate(R.layout.thumbnail_list, this,
				true);
	...
	public void setCurrentThumb(String url) {
		mCurrentURL = url;
		mImageManager.displayImage(mCurrentURL
				+ mImageSizes.getMain(),
				(Activity) mContext, mMainImage);
		mMainImage.setTag(url);
	}

	public void setThumbnailDimensions(float height,
			float width) {
