...
public class WebViewFragment extends SherlockFragment
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View view = inflater.inflate(
				R.layout.web_view_fragment, container,
				false);
	...
	public void onViewGuide(int guideid) {
		...
		intent.putExtra(TopicGuideListFragment.GUIDEID,
				guideid);
	...
	private class GuideWebView extends WebViewClient {
		...
		public GuideWebView(
				OnViewGuideListener guideListener) {
		...
		public boolean shouldOverrideUrlLoading(
			...
			try {
				if (pieces[GUIDE_POSITION]
						.equals(GUIDE_URL)
						|| pieces[GUIDE_POSITION]
								.equals(TEARDOWN_URL)) {
					guideid = Integer
							.parseInt(pieces[GUIDEID_POSITION]);
