...
public class TopicListAdapter extends Section {
	...
	public void setTopicSelectedListener(
			TopicSelectedListener topicListener) {
	...
	public void onItemClick(AdapterView<?> adapterView,
		...
		if (mTopicListener != null) {
			mTopicListener.onTopicSelected(mTopicList
					.get(position));

			if (prevSelected != null) {
				((TopicListRowView) prevSelected)
						.clearCurrentTopicStyle();
			}

			((TopicListRowView) view)
					.setCurrentTopicStyle();
