...
import com.dozuki.ifixit.ui.guide_create.ChooseBulletDialog.BulletDialogListener;
import com.dozuki.ifixit.ui.guide_create.GuideCreateBulletReorderFragment.BulletRearrangeListener;
...
public class GuideCreateEditBulletFragment extends Fragment implements BulletDialogListener, BulletRearrangeListener {
   ...
   public void setGuideDirty() {
      ((GuideCreateStepEditFragment.GuideStepChangedListener) getActivity()).onGuideStepChanged();
   }
