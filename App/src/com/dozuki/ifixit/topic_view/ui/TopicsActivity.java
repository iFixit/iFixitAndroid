...
public class TopicsActivity extends SherlockFragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle(
				((MainApplication) getApplication()).getSiteDisplayTitle());
	...
	public void onBackStackChanged() {
		...
		getSupportActionBar().setDisplayHomeAsUpEnabled(
				mBackStackSize != 0 || UP_NAVIGATION_FINISH_ACTIVITY);
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			 ...
			 * navigation button should finish the activity, finish the
			 * activity. Note: Although this is a warning for iFixit, it is not
			 * for Dozuki.
			 */
